...
<head>
    ...
    <title>Terselesaikan - Aduin</title>
        ...
        <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
            <div class="container-fluid d-flex flex-column p-0">
                ...
                <ul class="nav navbar-nav text-light" id="accordionSidebar">
					...
					<li class="nav-item" role="presentation"><a class="nav-link active" href="complaints_solved.php"><i class="fas fa-check-circle"></i><span>Terselesaikan</span></a></li>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content">
                ...
                <div class="container-fluid">
                    <h3 class="text-dark mb-4">Pengaduan Terselesaikan</h3>
                    <div class="card shadow">
                        <div class="card-header py-3">
                            <p class="text-primary m-0 font-weight-bold">daftar semua aduan yang terselesaikan</p>
                        </div>
                        <div class="card-body">
