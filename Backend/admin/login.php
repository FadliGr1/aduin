...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $user_data = mysqli_query(
        $conn,
        "SELECT * FROM cms_admin WHERE admin_mail = '$user_mail' and admin_pass = '$user_pass'"
    );
            ...
            <div class="col-md-9 col-lg-12 col-xl-10">
                <div class="card shadow-lg o-hidden border-0 my-5">
                    <div class="card-body p-0">
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-flex aligm-self-center">
                                <div class="flex-grow-1 bg-login-image" style="background-image: url(&quot;assets/img/admin.png&quot;); max: width 50px;"></div>
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" method="POST" action="">
                                        ...
                                        </div><button class="btn btn-primary btn-block text-white btn-user" value="submit" type="submit">Masuk</button>
                                    ...
                                    <div class="text-center pt-3"><a class="small" href="forgot-password.html">Lupa Password?</a></div>
