...
if ($_SERVER['REQUEST_METHOD'] == 'POST' and isset($_POST['title'])) {
    ...
    $link = "lihat-aduan.php?id=" . $_SESSION['c_id'];
            ...
            <div id="my-slider" class="carousel slide" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="assets/img/header-update.png" class="d-block w-100" alt="carousel">
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-md-10 offset-md-1">
                        ...
                        <select class="flex-fill" name="category" required="" style="margin: 15px;">
                            <optgroup label="Select Status">
                                <option value="Layanan Umum" <?php if ($fetch_complaint['category'] == "General") {
                                                                    echo "selected";
                                                                } ?>>Layanan Umum</option>
                                <option value="Layanan Kesehatan" <?php if ($fetch_complaint['category'] == "Service Related") {
                                                                        echo "selected";
                                                                    } ?>>Layanan Kesehatan</option>
                                <option value="Layanan Transportasi" <?php if ($fetch_complaint['category'] == "Technical") {
                                                                            echo "selected";
                                                                        } ?>>Layanan Transportasi</option>
                            </optgroup>
                        </select>
                        <div class="intro"></div>
